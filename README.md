...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `12.9µs` | `7.1µs` |
| [Day 2](./src/bin/02.rs) | `22.3µs` | `268.3µs` |
| [Day 3](./src/bin/03.rs) | `9.3µs` | `24.0µs` |
| [Day 4](./src/bin/04.rs) | `148.7µs` | `46.3µs` |
| [Day 5](./src/bin/05.rs) | `1.5ms` | `4.5ms` |
